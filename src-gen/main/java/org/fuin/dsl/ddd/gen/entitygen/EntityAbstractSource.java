...
public class EntityAbstractSource extends AbstractSource implements ArtifactFactory<Entity> {
  ...
  public GeneratedArtifact create(final Entity entity) throws GenerateException {
    ...
    GeneratedArtifact _generatedArtifact = new GeneratedArtifact("AbstractEntity", filename, _string);
