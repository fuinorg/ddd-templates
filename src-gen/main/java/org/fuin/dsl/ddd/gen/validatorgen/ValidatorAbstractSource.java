...
public class ValidatorAbstractSource extends AbstractSource implements ArtifactFactory<Constraint> {
  ...
  public GeneratedArtifact create(final Constraint constraint) throws GenerateException {
    ...
    GeneratedArtifact _generatedArtifact = new GeneratedArtifact("AbstractValidator", filename, _string);
