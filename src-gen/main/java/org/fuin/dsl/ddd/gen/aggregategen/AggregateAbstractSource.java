...
public class AggregateAbstractSource extends AbstractSource implements ArtifactFactory<Aggregate> {
  ...
  public GeneratedArtifact create(final Aggregate aggregate) throws GenerateException {
    ...
    GeneratedArtifact _generatedArtifact = new GeneratedArtifact("AbstractAggregate", filename, _string);
