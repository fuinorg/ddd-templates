...
public class CtxEventRegistryArtifactFactory extends AbstractSource<ResourceSet> {
  ...
  public CharSequence create(final String pkg, final String ctx, final List<Event> events, final ResourceSet resourceSet) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("final EntityIdPathConverter entityIdPathConverter = new EntityIdPathConverter();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("entityIdPathConverter.setFactory(entityIdFactory);");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public Deserializer getDeserializer(final String type,");
    _builder.newLine();
    _builder.append("     ");
    _builder.append("final int version, final String mimeType, final Charset encoding) {");
    _builder.newLine();
    _builder.append("\t\t");
