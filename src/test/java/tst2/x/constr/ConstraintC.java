...
@Retention(RUNTIME)
@Constraint(validatedBy = ConstraintCValidator.class)
@Documented
// CHECKSTYLE:OFF:LineLength
public @interface ConstraintC {

	/** Used to create an error message. */
	String message() default "C is not allowed: ${validatedValue.a} - ${validatedValue.b} - ${validatedValue.c}";
